...
const PREDEFINED_SKILLS = [
  ...
  { name: "Active Listening", category: "Soft Skills", icon: "Ear" },
  { name: "Written Communication", category: "Soft Skills", icon: "PenLine" },
  { name: "Storytelling", category: "Soft Skills", icon: "BookOpen" },
  { name: "Negotiation", category: "Soft Skills", icon: "Handshake" },
  { name: "Conflict Resolution", category: "Soft Skills", icon: "Shield" },
  { name: "Empathy", category: "Soft Skills", icon: "Heart" },
  { name: "Emotional Intelligence", category: "Soft Skills", icon: "Heart" },
  { name: "Teamwork", category: "Soft Skills", icon: "Users" },
  { name: "Collaboration", category: "Soft Skills", icon: "Users" },
  { name: "Cross-functional Collaboration", category: "Soft Skills", icon: "Users" },
  { name: "Leadership", category: "Soft Skills", icon: "Crown" },
  { name: "Mentorship", category: "Soft Skills", icon: "GraduationCap" },
  { name: "Coaching", category: "Soft Skills", icon: "GraduationCap" },
  { name: "Decision Making", category: "Soft Skills", icon: "GitBranch" },
  { name: "Critical Thinking", category: "Soft Skills", icon: "Brain" },
  { name: "Problem Solving", category: "Soft Skills", icon: "Lightbulb" },
  { name: "Analytical Thinking", category: "Soft Skills", icon: "BarChart" },
  { name: "Strategic Thinking", category: "Soft Skills", icon: "Target" },
  { name: "Creativity", category: "Soft Skills", icon: "Sparkles" },
  { name: "Innovation", category: "Soft Skills", icon: "Lightbulb" },
  { name: "Adaptability", category: "Soft Skills", icon: "Shuffle" },
  { name: "Flexibility", category: "Soft Skills", icon: "Shuffle" },
  { name: "Resilience", category: "Soft Skills", icon: "Shield" },
  { name: "Time Management", category: "Soft Skills", icon: "Clock" },
  { name: "Prioritization", category: "Soft Skills", icon: "ListOrdered" },
  { name: "Organization", category: "Soft Skills", icon: "FolderTree" },
  { name: "Self-Motivation", category: "Soft Skills", icon: "Zap" },
  { name: "Work Ethic", category: "Soft Skills", icon: "Award" },
  { name: "Attention to Detail", category: "Soft Skills", icon: "Eye" },
  { name: "Curiosity", category: "Soft Skills", icon: "Search" },
  { name: "Continuous Learning", category: "Soft Skills", icon: "BookOpen" },
  { name: "Growth Mindset", category: "Soft Skills", icon: "TrendingUp" },
  { name: "Open-mindedness", category: "Soft Skills", icon: "Brain" },
  { name: "Patience", category: "Soft Skills", icon: "Clock" },
  { name: "Stress Management", category: "Soft Skills", icon: "Activity" },
  { name: "Project Management", category: "Soft Skills", icon: "Kanban" },
  { name: "Agile Methodology", category: "Soft Skills", icon: "RefreshCw" },
  { name: "Scrum", category: "Soft Skills", icon: "RefreshCw" },
  { name: "Kanban", category: "Soft Skills", icon: "Kanban" },
  { name: "Risk Management", category: "Soft Skills", icon: "ShieldAlert" },
  { name: "Stakeholder Management", category: "Soft Skills", icon: "Users" },
  { name: "Client Management", category: "Soft Skills", icon: "Briefcase" },
  { name: "Customer Focus", category: "Soft Skills", icon: "Smile" },
  { name: "Cultural Awareness", category: "Soft Skills", icon: "Globe" },
  { name: "Remote Collaboration", category: "Soft Skills", icon: "Wifi" },
  { name: "Code Review", category: "Soft Skills", icon: "GitPullRequest" },
  { name: "Pair Programming", category: "Soft Skills", icon: "Users" },
  { name: "Technical Writing", category: "Soft Skills", icon: "FileText" },
  { name: "Documentation", category: "Soft Skills", icon: "FileText" },
  { name: "Presentation Skills", category: "Soft Skills", icon: "Presentation" },
  { name: "Networking", category: "Soft Skills", icon: "Network" },
  { name: "Self-Discipline", category: "Soft Skills", icon: "Target" },
  { name: "Accountability", category: "Soft Skills", icon: "CheckCircle" },
  { name: "Ownership", category: "Soft Skills", icon: "Flag" },
  { name: "Initiative", category: "Soft Skills", icon: "Rocket" },
  { name: "Entrepreneurial Mindset", category: "Soft Skills", icon: "Rocket" },

  // Achievements
  { name: "Hackathon Winner", category: "Achievements", icon: "Trophy" },
  { name: "Hackathon Finalist", category: "Achievements", icon: "Medal" },
  { name: "1st Place Coding Competition", category: "Achievements", icon: "Trophy" },
  { name: "2nd Place Coding Competition", category: "Achievements", icon: "Medal" },
  { name: "3rd Place Coding Competition", category: "Achievements", icon: "Award" },
  { name: "Top 10 Final Project", category: "Achievements", icon: "Star" },
  { name: "Best Project Award", category: "Achievements", icon: "Trophy" },
  { name: "Best UI/UX Award", category: "Achievements", icon: "Sparkles" },
  { name: "Innovation Award", category: "Achievements", icon: "Lightbulb" },
  { name: "Employee of the Month", category: "Achievements", icon: "Star" },
  { name: "Employee of the Year", category: "Achievements", icon: "Trophy" },
  { name: "Promoted to Senior", category: "Achievements", icon: "TrendingUp" },
  { name: "Promoted to Lead", category: "Achievements", icon: "TrendingUp" },
  { name: "Tech Lead", category: "Achievements", icon: "Crown" },
  { name: "Open Source Contributor", category: "Achievements", icon: "GitBranch" },
  { name: "GitHub Star", category: "Achievements", icon: "Star" },
  { name: "1k+ GitHub Stars", category: "Achievements", icon: "Star" },
  { name: "10k+ GitHub Stars", category: "Achievements", icon: "Star" },
  { name: "Published NPM Package", category: "Achievements", icon: "Package" },
  { name: "Published Author", category: "Achievements", icon: "BookOpen" },
  { name: "Conference Speaker", category: "Achievements", icon: "Mic" },
  { name: "Workshop Facilitator", category: "Achievements", icon: "Presentation" },
  { name: "Community Mentor", category: "Achievements", icon: "GraduationCap" },
  { name: "Dean's List", category: "Achievements", icon: "Award" },
  { name: "Cum Laude", category: "Achievements", icon: "GraduationCap" },
  { name: "Magna Cum Laude", category: "Achievements", icon: "GraduationCap" },
  { name: "Summa Cum Laude", category: "Achievements", icon: "GraduationCap" },
  { name: "Graduated with Distinction", category: "Achievements", icon: "GraduationCap" },
  { name: "Valedictorian", category: "Achievements", icon: "Crown" },
  { name: "Scholarship Recipient", category: "Achievements", icon: "Award" },
  { name: "Full Scholarship", category: "Achievements", icon: "Award" },
  { name: "Merit Scholarship", category: "Achievements", icon: "Award" },
  { name: "Research Grant", category: "Achievements", icon: "FlaskConical" },
  { name: "Published Research Paper", category: "Achievements", icon: "FileText" },
  { name: "Patent Holder", category: "Achievements", icon: "FileBadge" },
  { name: "AWS Certified", category: "Achievements", icon: "Cloud" },
  { name: "AWS Solutions Architect", category: "Achievements", icon: "Cloud" },
  { name: "Google Cloud Certified", category: "Achievements", icon: "Cloud" },
  { name: "Azure Certified", category: "Achievements", icon: "Cloud" },
  { name: "Kubernetes Certified (CKA)", category: "Achievements", icon: "Network" },
  { name: "Certified Scrum Master", category: "Achievements", icon: "RefreshCw" },
  { name: "PMP Certified", category: "Achievements", icon: "Briefcase" },
  { name: "Meta Front-End Certified", category: "Achievements", icon: "Award" },
  { name: "Google UX Certified", category: "Achievements", icon: "Award" },
  { name: "TOEFL High Score", category: "Achievements", icon: "Languages" },
  { name: "IELTS Band 8+", category: "Achievements", icon: "Languages" },
  { name: "Featured on Product Hunt", category: "Achievements", icon: "Rocket" },
  { name: "Product Hunt Top 5", category: "Achievements", icon: "Trophy" },
  { name: "Featured on Hacker News", category: "Achievements", icon: "Flame" },
  { name: "Startup Founder", category: "Achievements", icon: "Rocket" },
  { name: "YC Alumni", category: "Achievements", icon: "Rocket" },
  { name: "Raised Seed Funding", category: "Achievements", icon: "Coins" },
  { name: "100k+ Users Reached", category: "Achievements", icon: "Users" },
  { name: "1M+ Users Reached", category: "Achievements", icon: "Users" },
  { name: "Volunteer of the Year", category: "Achievements", icon: "Heart" },
  { name: "Community Leader", category: "Achievements", icon: "Users" },
  { name: "Tech Meetup Organizer", category: "Achievements", icon: "Calendar" },
];
