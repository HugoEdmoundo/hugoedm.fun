-- ============================================================
-- FULL SETUP SCRIPT — paste this into Supabase SQL Editor
-- on the NEW project to recreate all tables, policies, storage
-- ============================================================
...
-- ── 7. DEFAULT SITE CONFIG ───────────────────────────────────
INSERT INTO public.site_config (site_name, description, github_username, hero_name, hero_headline)
VALUES ('My Portfolio', 'Welcome to my portfolio', '', 'Your Name', 'Full Stack Developer');
